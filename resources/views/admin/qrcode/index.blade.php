...
<style>
    ...
    /* แถบหัวข้อย่อยเหนือหัวตาราง (เทาอ่อน โค้งมน) */
    .subhead-strip{
        background:#F5F8FA; border-radius:8px; padding:10px 14px;
        color:#3F4254; font-weight:600; font-size:12px;
    }

    /* สีหัวตาราง */
    .table thead tr.table-head-gray th{
        background:#F5F8FA;  /* เทาอ่อนตามภาพ */
        color:#5E6278;       /* เทาเข้มข้อความ */
        text-transform:none; /* ไม่แปลงเป็นตัวใหญ่ */
        font-weight:700;
        border-bottom:0;
    ...
    /* แถวค้นหา */
    .search-wide .form-control{border-right:0}
    .search-wide .btn{border-left:0}
</style>
@stop('stylesheet')
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="{{ url('admin/qrcode/create') }}" class="btn btn-light-primary fw-bold">เพิ่มรายการ</a>
                </div>
            </div>
        </div>
                ...
                <div class="row g-5 mb-7">
                    <div class="col-md-4">
                        <div class="card kpi-card p-5">
                            ...
                            <div class="value text-success">0000</div>
                ...
                <div class="row g-5 g-xl-8">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="search-wide input-group mb-6">
                    ...
                    <button class="btn btn-light" type="button" id="button-search">
                                ...
                                <div class="card-title">
                                    <div class="d-flex align-items-center">
                                        <span class="fw-bold me-3 fs-8">เลือกดูตาม ประเภทสินค้า</span>
                                        ...
                                        <span class="fw-bold me-3 fs-8">เลือกดูตามวันที่ผลิต</span>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item" href="{{ url('admin/qrcode/edit/1') }}">แก้ไขรายการ</a></li>
                                                                <li><a class="dropdown-item" href="#">ดาวน์โหลดไฟล์</a></li>
                                                                <li><a class="dropdown-item" href="#">แสดงข้อมูลสินค้า</a></li>
